                ...
                <div class="card wizard-card" data-color="orange" id="wizard">
                    ...
                    <div class="tab-pane" id="resultados_finales">
                        <div class="row">
                            ...
                            <div class="col-md-12 text-center">
                                 <div class="btn-group">
                                    <button type="button" class="btn btn-danger">PRESIDENTE</button>
                                    <button type="button" class="btn btn-danger">SENADOR</button>
                                    <button type="button" class="btn btn-danger">DIPUTADO</button>
                                    <button type="button" class="btn btn-danger">AYUNTAMIENTO</button>
                                </div> 
                            </div>
                        </div>
