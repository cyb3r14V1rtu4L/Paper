    ...
    <div class="container-fluid">
                    ...
                    <div class="content">
                        ...
                        <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <span class="text-info"><h5><b>4,312</b></h5></span>
                                        <span class="text-danger">PRI - PVE - PANAL 30%</span>
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PAN - PRD 30%
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PAN - MC 30%
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-5">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PRD - MC 30%
                                    </div>
                    ...
                    <div class="content">
                        <ul class="list-unstyled team-members">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <span class="text-info"><h5><b>5,269</b></h5></span>
                                        <span class="text-danger">PRI - PVE - PANAL 30%</span>
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PRI - PVE 30%</span>
                                    </div>
                            ...
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PRI - PANAL 30%</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <div class="row">
                                    ...
                                    <div class="col-xs-7">
                                        <span class="text-success"><h5><b>1,023</b></h5></span>
                                        <span class="text-danger">PVE - PANAL 30%</span>
                                    </div>
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-xs-5">
                                    No Registrados
                                    <br>
                                    <span class="text-success"><h5>894</h5></span>
                                    30%
                                </div>
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-xs-5">
                                    Votos Nulos
                                    <br>
                                    <span class="text-success"><h5>420</h5></span>
                                    30%
                                </div>
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    <div class="header">
                        <h5 class="title">PARTIDOS CON INCIDENCIAS</h5>
                    </div>
                    <div class="content">
                        <ul class="list-unstyled team-members">
                            <li>
